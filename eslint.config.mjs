...
const restrictedEffectHookNames = ['useEffect', 'useLayoutEffect', 'useInsertionEffect']
...
const effectHookRestrictionRules = {
  ...
  'no-restricted-syntax': [
    ...
    },
    {
      ...
      message: 'for..in is disallowed. Use Object.keys/Object.entries with Object.hasOwn instead.',
    },
    {
...
const eslintConfig = tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      'no-restricted-syntax': effectHookRestrictionRules['no-restricted-syntax'].filter(
        (rule) =>
          typeof rule === 'string' ||
          !rule.selector?.includes('useEffect|useLayoutEffect|useInsertionEffect'),
      ),
    },
  },
)
