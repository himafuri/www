    ...
    <>
      ...
      <header className="navbar">
        <div className="navbar__inner">
          <a className="navbar__brand" href="#top" aria-label="HIMAFURI beranda">
            <Image src="/himafurilogo.png" alt="Logo HIMAFURI" width={36} height={36} priority />
          </a>
      ...
      <main id="top">
          ...
          <div className="hero__inner">
            ...
            <div className="hero__content">
              ...
              <p className="hero__lead">
                Persekutuan Mahasiswa Furry Indonesia dari berbagai macam perguruan tinggi.
              </p>
              ...
              <a className="btn btn--primary" href="https://discord.com" target="_blank" rel="noopener noreferrer">
                Gabung ke Discord
              </a>
            </div>
          </div>
        ...
        <section className="vision-mission">
          <div className="card">
            <h2>Visi</h2>
            <p>
              Merangkul mahasiswa-mahasiswa Perguruan Tinggi di Indonesia yang memiliki
              ketertarikan terhadap komunitas furry.
            </p>
          </div>
          <div className="card">
            <h2>Misi</h2>
            <p>
              Melakukan segala kegiatan HIMAFURI terutama dalam mencari mahasiswa-mahasiswa yang
              tersebar di berbagai Perguruan Tinggi di Indonesia secara konsisten untuk mencapai
              Visi HIMAFURI.
            </p>
          </div>
        </section>
      ...
      <footer className="footer">
        <div className="footer__top">
          <div className="footer__brand">
            <Image src="/himafurilogo.png" alt="Logo HIMAFURI" width={48} height={48} />
            <div>
              <p className="footer__brand-name">Himpunan Mahasiswa Furry Indonesia</p>
              <p className="footer__copyright">© 2026 Himpunan Mahasiswa Furry Indonesia</p>
            </div>
          </div>
          ...
          <nav className="footer__col">
            ...
            <ul>
              ...
              <li><a href="#">Peraturan &amp; Tata Tertib</a></li>
              <li><a href="#">Tautan Penting</a></li>
            </ul>
          </nav>
          ...
          <nav className="footer__col">
            ...
            <ul>
              ...
              <li><a href="https://discord.com" target="_blank" rel="noopener noreferrer">Gabung ke Discord Kami</a></li>
            </ul>
          </nav>
        </div>
